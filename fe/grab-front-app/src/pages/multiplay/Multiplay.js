...
function TitleSingleplay() {
    return (
        <div className="titleMultiplay">SINGLE PLAY</div>
    )
}
...
function SingleplayWaiting(){
    ...
    return(
        <div className="containerMultiplay">
            {/* <ButtonHome/> */}
            <TitleSingleplay />
            <div className='camandmessageboxMultiplay' style={{display:'flex'}}>
                <div className='mainSectionMultiplay'>
                    <div className='multicontainerMultiplay'>
                    <div className="gameContainerWaitingMultiplay">
                        <video id="videoZoneWaitingMultiplay" ref={videoRef} autoPlay playsInline></video>
                        <canvas id="canvasZoneWaitingMultiplay" ref={canvasElementRef}></canvas>
                    </div>
                    <div className='bigboxMultiplay'>
                    <div style={{display:'flex'}}>
                    <div className='cambox1Multiplay'>cambox1</div>
                    <div className='cambox2Multiplay'>cambox2</div>
                    </div>
                    <div style={{display:'flex'}}>
                    <div className='cambox3Multiplay'>cambox3</div>
                    <div className='cambox4Multiplay'>cambox4</div>
                    </div>
                    </div>
                ...
                {!isGamePlayingState
                ?
                <div className='subContainerMultiplay'>
                    <MusicCard musicList = {musicList} selectedMusic={selectedMusic} handleMusicSelect= {handleMusicSelect} />
                    <button type="submit" className="startbuttonMultiplay" onClick={playGame} >START</button>
                </div>
                :
                <ScoreBox
...
function ScoreBox({perfectScore, goodScore, failedScore, highestCombo, comboScore, stopGame}){
    return(
        <div className="scoreBoxMultiplay">
